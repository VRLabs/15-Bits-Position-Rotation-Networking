# 14 Bits Position Rotation Networking
...
"14BitsPositionRotationNetworking/Control" is a synced parameter, so click the checkbox within the tool to add it to your avatar's parameter asset.

Everything under "14BitsPositionRotationNetworking/Send/" is also a synced parameter. There are 7 Booleans and 1 Float that should be synced in total.

"14 Bits Position Rotation Networking.prefab" should go to the base of your Unity scene, which will give it base Unity scaling.

Unpack the prefab by right-clicking it and move the prefab to base of your avatar.

## How to use

The "14BitsPositionRotationNetworking/Control" parameter must be True to start the system. Changing it to False will stop and reset the system.

Locate "14 Bits Position Rotation Networking/14 Bits Position Rotation Networking Target" and take it out of the prefab hierarchy. Place it somewhere that will be in world space by the time you set 14BitsPositionRotationNetworking/Control as True, as you should be trying to sync a world object.

Constrain your world prop to the "14 Bits Position Rotation Networking/World/Result" transform. By default, 14 Bits Position Rotation Networking/Cube is constrained to it. 14 Bits Position Rotation Networking/World/Result will start at world 0,0,0 and when networking is finished, it will move to the synced transforms. I recommend testing the prefab like this until you know what to expect.

## Visibility

"Active" players will have loaded your avatar before setting 14BitsPositionRotationNetworking/Control to True. "Late" players loaded your avatar after 14BitsPositionRotationNetworking/Control is True. There is another kind of player that uses the Avatar Distance Hider and did not finish networking before your avatar was hidden. They should be treated as late. Try to show the most appropriate effect to the player.

"14BitsPositionRotationNetworking/Finished" will be True when a player has finished networking.

"14BitsPositionRotationNetworking/Interrupted" will be True if a player has distance hidden you during networking, and didn't finish.
...
The examples use a [World Constraint](https://github.com/VRLabs/World-Constraint) and expects the 14 Bits Position Rotation Networking Target to be in World Constraint/Container.
