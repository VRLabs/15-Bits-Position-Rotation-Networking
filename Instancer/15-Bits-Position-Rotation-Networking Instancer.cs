...
namespace VRLabs.FifteenBitsPositionRotationNetworking
{
	public class FifteenBitsPositionRotationNetworking : ScriptableObject
	{
		public const string packageName = "15-Bits-Position-Rotation-Networking";
		...
		public static void FancyPackage()
		{
			...
			var editor = ScriptableObject.CreateInstance<FifteenBitsPositionRotationNetworking>();
